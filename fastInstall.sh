...
sudo pacman -S --needed --noconfirm --disable-download-timeout base-devel man-db julia php go cairo curl calc p7zip sed tldr fd ripgrep fzf vim neovim neofetch ranger hyprland kitty hyprpaper obsidian powerline-fonts bluez signal-desktop telegram-desktop discord pipewire wireplumber spotifyd easyeffects chromium btop grim slurp calcurse testdisk gtk-layer-shell rustup neovide cmatrix nvtop bookworm gimp networkmanager bluez kalgebra bat gzip ruby nautilus openvpn qopenvpn fish fisher qqwing
