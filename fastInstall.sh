...
sudo pacman -S --needed --noconfirm --disable-download-timeout base-devel i3-wm i3status nitrogen julia php go cairo curl calc p7zip sed tldr fd ripgrep fzf vim neovim neofetch ranger kitty obsidian powerline-fonts pipewire wireplumber chromium btop grim slurp testdisk rustup neovide cmatrix nvtop bookworm git github-cli dmenu
